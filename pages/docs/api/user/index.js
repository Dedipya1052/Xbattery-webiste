    ...
    <div className="min-h-screen bg-gray-950 p-2 sm:p-4 md:p-6">
      ...
      <div className="space-y-4 sm:space-y-3 md:space-y-4">
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 px-2 sm:px-4 md:px-8">
          <div className="flex-1">
            <div className="bg-gray-900/50 rounded-lg p-4 sm:p-6 h-full">
              <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">Base URL</h2>
              <div className="text-sm sm:text-base text-gray-300 space-y-4">
                <p>
                  All user-related API requests should be made to our secure endpoint:
                </p>
                <code className="text-blue-400 block text-sm break-all">
                  https://bess-apim-dev.azure-api.net/users
                </code>
                <p>
                  This endpoint is secured with Azure API Management and requires authentication
                  for all requests. HTTPS is mandatory for all API calls.
                </p>
              </div>
            </div>
          </div>
          <div className="w-full lg:w-[45%] relative">
            <div className="bg-gray-900 rounded-lg p-4 sm:p-6 h-auto sticky top-20 right-0">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xs sm:text-sm font-semibold text-gray-400">BASE URL</h3>
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 px-2 sm:px-4 md:px-8">
          <div className="flex-1">
            <div className="bg-gray-900/50 rounded-lg p-4 sm:p-6 h-auto">
              <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">Authentication</h2>
              <div className="space-y-4 text-sm sm:text-base text-gray-300">
                <p>
                  User API endpoints require both an API key and a valid JWT token for authentication.
            ...
            <div className="bg-gray-900 rounded-lg p-4 sm:p-6 h-auto sticky top-20 right-0">
              <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-xs sm:text-sm font-semibold text-gray-400">AUTHENTICATION EXAMPLE</h3>
                  <div className="flex items-center gap-2">
                    <select 
                      ...
                      value={selectedLang}
                    >
                      <option value="curl" className="bg-gray-900">cURL</option>
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 px-2 sm:px-4 md:px-8">
          <div className="flex-1">
            <div className="bg-gray-900/50 rounded-lg p-4 sm:p-6 h-auto">
              <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">Available Endpoints</h2>
              <div className="space-y-4 text-sm sm:text-base text-gray-300">
          ...
          <div className="w-full lg:w-[45%] relative">
            <div className="bg-gray-900 rounded-lg p-4 sm:p-6 h-auto sticky top-20 right-0">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xs sm:text-sm font-semibold text-gray-400">ENDPOINT EXAMPLE</h3>
                <CopyButton text={`// Get user profile
GET /profile
...
POST /preferences
{
  ...
  "language": "en"
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 px-2 sm:px-4 md:px-8 mb-8">
          <div className="flex-1">
            <div className="bg-gray-900/50 rounded-lg p-4 sm:p-6 h-full">
              <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">Response Format</h2>
              <div className="space-y-4 text-sm sm:text-base text-gray-300">
                <p>All endpoints return data in JSON format with consistent structure:</p>
                <div className="bg-gray-800 p-3 sm:p-4 rounded-md">
                  <h3 className="font-semibold mb-3">Response Structure</h3>
                  <ul className="space-y-3">
                    <li>
                      <code className="text-blue-400">success</code>: Boolean
                      <p className="text-xs sm:text-sm text-gray-400">Operation status</p>
                    </li>
                    <li>
                      <code className="text-blue-400">data</code>: Object
                      <p className="text-xs sm:text-sm text-gray-400">Response payload</p>
                    </li>
                    <li>
                      <code className="text-blue-400">message</code>: String
                      <p className="text-xs sm:text-sm text-gray-400">Human-readable response message</p>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="w-full lg:w-[45%] relative">
            <div className="bg-gray-900 rounded-lg p-4 sm:p-6 h-auto sticky top-20 right-0">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xs sm:text-sm font-semibold text-gray-400">RESPONSE EXAMPLE</h3>
                <CopyButton text={`{
  "success": true,
  "data": {
    "id": "usr_123456",
