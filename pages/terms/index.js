      ...
      >
        ...
        <div className={classes.affiliateholder}>
          ...
          <ul className={classes.ulholder}>
            ...
            <p>
              4.3 Customers are encouraged to follow best practices provided in
              the user manual to maximize efficiency.
            </p>
          </ul>
        </div>
        ...
        <div className={classes.affiliateholder}>
          ...
          <ul className={classes.ulholder}>
            <p>
              6.1 Customers agree to use the Product in accordance with fair use
              principles.
            </p>
            <p>
              6.2 Excessive or abnormal use that strains the Product beyond its
        ...
        <div className={classes.affiliateholder}>
          ...
          <ul className={classes.ulholder}>
            <p>
              8.1 The Product comes with a limited warranty as specified in the
              warranty document.
            </p>
            <p>
              8.2 The warranty does not cover damage from misuse, accidents, or
              unauthorized modifications.
            </p>
            <p>
              8.3 To the extent permitted by law, all other warranties, express
        ...
        <div className={classes.affiliateholder}>
          ...
          <ul className={classes.ulholder}>
            <p>
              9.1 The Product may collect usage data to improve performance and
              customer service.
            </p>
            <p>
              9.2 All data collection and use is subject to our Privacy Policy,
              which can be found at [Insert Privacy Policy URL].
            </p>
          </ul>
        </div>
        ...
        <div className={classes.affiliateholder}>
          ...
          <ul className={classes.ulholder}>
            ...
            <p>
              10.4 Energy Generation Companies: Must comply with grid connection
              regulations and ensure the Product's compatibility with their
              generation systems.
            </p>
          </ul>
        </div>
        ...
        <div className={classes.affiliateholder}>
          ...
          <ul className={classes.ulholder}>
            ...
            <p>
              12.2 Customers may terminate their use of the Product at any time,
              subject to any ongoing contractual obligations.
            </p>
          </ul>
        </div>
        ...
        <div className={classes.affiliateholder}>
          ...
          <ul className={classes.ulholder}>
            <p>
              14.1 If any provision of these Terms is found to be unenforceable,
        ...
        <div className={classes.affiliateholder}>
          ...
          <ul className={classes.ulholder}>
            <p>
              16.1 These Terms constitute the entire agreement between XBattery
              and the Customer regarding the Product.
            </p>
          </ul>
        </div>
        ...
        <div className={classes.affiliateholder}>
          ...
          <ul className={classes.ulholder}>
            <p>
              17.1 XBattery's failure to enforce any right or provision of these
        ...
        <div className={classes.affiliateholder}>
          ...
          <ul className={classes.ulholder}>
            ...
            <p>
              19.2 Any disputes arising from these Terms shall be subject to the
