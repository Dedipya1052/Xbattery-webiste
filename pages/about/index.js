...
const About = () => {
  ...
  return (
    ...
    <div className={`${classes.head1} bg-black`}>
        ...
        <AnimatedDiv>
          <div className="text-center mb-12 text-white w-[90%] mx-auto">
            ...
            <p className="text-lg mt-[2rem] ">
              ...
              solutions, pushing the boundaries of what's possible in portable
              power technology.
            </p>
            <p className="text-lg">
          ...
          {/* <div className="flex flex-col gap-[4rem] justify-around bg-[#1f1e1e] py-16 pb-[15rem]  mt-[5rem] mb-[30rem] h-[30rem] ">
      <div className=" flex justify-around">
        <div className="text-center text-white">
        <div className=" flex gap-[0.4rem] justify-center items-center mb-[1rem]">
        <Image src={"/images/about/teams/shortimages/1.png"} height={"50"} width={"50"} className=" rounded-full"/>
        <Image src={"/images/about/teams/shortimages/2.png"} height={"50"} width={"50"} className=" rounded-full"/>
        <Image src={"/images/about/teams/shortimages/3.png"} height={"50"} width={"50"} className=" rounded-full"/>

        </div>
        <h3 className="text-2xl font-bold">Meet Our Leadership Team</h3>
        ...
        <Image src={"/images/about/teams/shortimages/4.svg"} height={"45"} width={"45"} className=" rounded-full"/>
        
        </div>
          <h3 className="text-2xl font-bold">Join Our Team</h3>
          <p className="mt-2 mb-4">
            Make Xbatterythe best chapter of your career.
          </p>
          <Link href="/careers">
          <button className="bg-white text-black py-2 px-6 rounded-full font-semibold transition hover:bg-gray-300">
      ...
      <Image src={"/images/about/people/1.jpeg"} height={"600"} width={"600"} className="w-[30%] h-[450px] object-cover rounded-md"/>
      <Image src={"/images/about/people/2.jpeg"} height={"600"} width={"600"} className="w-[30%] h-[450px] object-cover rounded-md"/>
      <Image src={"/images/about/people/3.jpeg"} height={"600"} width={"600"} className="w-[30%] h-[450px] object-cover rounded-md"/>
          ...
          <div className="relative bg-[#1f1e1e] py-16 mt-[5rem] mb-[30rem] pb-[20rem] ">
            <div className="flex flex-col gap-[3rem] md:gap-0 md:flex-row justify-around relative z-10 w-[93%] md:w-[90%] xl:w-[85%] 2xl:w-[1450px] mx-auto">
              <div className="text-center text-white">
                ...
                <Link href="/about#teams" >
                  <button className="bg-white text-black py-2 px-6 rounded-full font-semibold transition hover:bg-gray-300" onClick={handleScroll}>
                    Meet Our Leaders
                  </button>
                </Link>
              </div>
          ...
          <div className=" bg-[#242323]  ">
            <div className="w-[93%] md:w-[90%] xl:w-[80%] 2xl:w-[1450px] mx-auto p-[1rem] pb-[2rem] bg-[#242323] flex flex-col md:flex-row gap-[2rem] md:gap-[4%]">
              <p className="text-white text-lg w-[100%] md:w-[48%] text-center  md:text-left">
                Xbattery was founded with the vision of revolutionizing the way
                energy is stored and consumed. Our story began when a group of
                engineers and innovators came together to solve one of the most
                pressing issues of modern times: sustainable energy storage.
                With the rise of renewable energy sources like solar and wind,
                it became evident that a solution was needed to store excess
                energy efficiently. Our team worked tirelessly, experimenting
                with different materials, battery chemistries, and technologies
                to create a product that not only stored energy but did so in a
                way that was both cost-effective and scalable.
              </p>
              <p className="text-white text-lg w-[100%] md:w-[48%] text-center  md:text-left">
                After years of research and development, Xbattery was born. Our
                batteries are designed to cater to a wide range of applications,
                from powering homes to supporting heavy industrial use. We
                believe in a future where energy is not only renewable but also
                reliable, where power outages and energy shortages are a thing
                of the past. With xBattery, we're not just providing a product;
                we're offering a solution that empowers individuals, businesses,
                and communities to take control of their energy needs. Our
                journey is just beginning, and we’re excited to continue pushing
                the boundaries of what’s possible in the energy storage space.
              </p>
            </div>
          </div>
          </AnimatedDiv>
     ...
     {/* teams */}
      ...
      <AnimatedDiv>
      <h2 className="text-lg text-white text-center font-semibold mb-[-0.3rem]">Meet Our Leaders</h2>
      ...
      The Xbattery Leadership Team
       ...
       <Image src={"/images/about/leaders/1.jpeg"} width={"600"} height={"600"}  className="w-full md:w-[30%] h-[350px] object-cover rounded-md"/>
       <div className="text-white  w-full md:w-[65%] flex flex-col gap-[1rem] text-center md:text-left">
       <div className=" text-2xl font-semibold">John Doe, CEO of Xbattery</div>
       <div className=" opacity-[80%] text-lg text-center md:text-left">
       John Doe is a visionary leader with over two decades of experience in the energy sector. His passion for sustainability and innovation has driven Xbattery’s mission to revolutionize energy storage solutions. Under his leadership, Xbattery has grown from a small startup into a leading player in the renewable energy industry, focusing on providing efficient, scalable, and affordable energy solutions for homes, businesses, and industries. John's deep understanding of the global energy landscape and his commitment to environmental responsibility continue to shape Xbattery’s future as a company that is pushing the boundaries of clean energy.
       </div>
       </div>
       </div>
       </AnimatedDiv>
       ...
       <Image src={"/images/about/leaders/2.jpeg"} width={"600"} height={"600"}  className="w-full md:w-[30%] h-[350px] object-cover rounded-md"/>
       <div className="text-white  w-full md:w-[65%] flex flex-col gap-[1rem] text-center md:text-left">
       <div className=" text-2xl font-semibold">Jane Smith, CTO of Xbattery</div>
       <div className=" opacity-[80%] text-lg">
       Jane Smith brings unparalleled technical expertise to the company with her background in electrical engineering and advanced battery technology. With a strong track record in research and development, Jane leads the innovation efforts at Xbattery, constantly exploring new ways to enhance battery performance, efficiency, and sustainability. Her forward-thinking approach and dedication to cutting-edge technology have been instrumental in the development of Xbattery's unique solutions, ensuring the company stays ahead in an ever-evolving industry. Jane’s leadership in technology drives Xbattery's goal of delivering state-of-the-art energy solutions for a greener future.
       </div>
       </div>
       </div>
       </AnimatedDiv>
     ...
     <AnimatedDiv>
      <div className="w-[93%] md:w-[90%] xl:w-[85%] 2xl:w-[1450px] mx-auto flex flex-col gap-[1.5rem] items-start justify-between relative overflow-hidden xl:overflow-visible">
        ...
        <div className="md:w-1/2 px-4 md:px-8 text-left">
          <h2 className={`${classes.block4Head}  mb-4 text-center md:text-left`}>XBattery’s team is driving sustainable energy for India</h2>
          <p className="text-md opacity-[80%] text-center md:text-left">
          The Xbattery team is dedicated to revolutionizing energy storage with advanced BMS, IoT, Digital Twins, and AI. We’re committed to optimizing clean energy solutions, working together to build a more sustainable future for India.          </p>
        </div>
         {/* Image Section */}
        ...
        <div className=" absolute top-20 right-[-6rem] ">
          <Image src={"/images/logo1.png"} height={650} width={650} className=" opacity-[3%] z-[-20px] hidden md:block"/>
        </div>
