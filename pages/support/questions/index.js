...
const QuestionCard = ({ question, index }) => {
  return (
    ...
    >
      <Link 
        href={`/support/questions/${question.slug}`}
        className="block bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-300 p-6 group"
      >
              ...
              >
                <div className="relative" ref={searchRef}>
                  ...
                  <input
                    ...
                    onChange={handleSearchInput}
                    onFocus={() => setShowSuggestions(true)}
                    className="w-full pl-12 pr-12 py-3 rounded-lg bg-white text-gray-800 placeholder-gray-500 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                  />
                  {searchQuery && (
                    <button
                      onClick={handleSearchClear}
              ...
              >
                ...
                {searchQuery && (
                  <span className="px-3 py-1 bg-gray-100 rounded-full text-sm flex items-center gap-1">
                    <span className="text-blue-600">Search:</span> {searchQuery}
                    <button 
                      onClick={handleSearchClear}
                ...
                {selectedCategory !== "all" && (
                  <span className="px-3 py-1 bg-gray-100 rounded-full text-sm flex items-center gap-1">
                    <span className="text-blue-600">Category:</span> {selectedCategory}
                    <button 
                      onClick={() => setSelectedCategory("all")}
                      className="ml-1 text-gray-500 hover:text-gray-700"
                    >
