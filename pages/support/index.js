...
//       exit={{ opacity: 0, y: -10 }}
//       className="absolute top-full left-0 right-0 mt-2 bg-[#f3f3f3] border border-[#aaaaaa] rounded-lg shadow-lg overflow-hidden z-50"
//     >
...
//                   onFocus={() => setShowSuggestions(true)}
//                   placeholder="Search help articles..."
//                   className="w-full pl-12 pr-12 py-3 rounded-lg bg-white text-gray-800 placeholder-gray-500 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
//                 />
//                 {searchQuery && (
//                   <button
//                     type="button"
...
//                 key={index}
//                 onClick={() => handleArticleClick(article.slug)}
//                 className="text-left bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:border-blue-300 hover:shadow-md transition-all duration-300 group"
//               >
//                 <div className="flex items-start space-x-4">
...
//                       <span className="text-xs px-2 py-1 bg-blue-50 rounded-full text-blue-600">
//                         {article.readTime}
//                       </span>
//                     </div>
//                   </div>
