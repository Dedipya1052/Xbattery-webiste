        ...
        <div className={styles.Footer_content__4wtov}>
          <div className={styles.footerHeader}>
            ...
            {/* <div className={styles.footerDescription}>
              Alter AI is an AI-powered image generation platform that uses
              machine learning models to offer image generation services
              catering to various industries, transforming visuals for
              professional use.
              <br />
            </div> */}
          </div>
          ...
          <div className={styles.footerElementDesktop}>
            ...
            <div className={styles.contactAndComp}>
              ...
              {/* <div className={styles.Footer_social__XfgO0}>
            <h3 className={styles.footerSubheading}>Contact</h3>
            <div className={styles.linksFot1}>
            <a href="mailto:help@getalter.ai" className={styles.footerElements}>
            <MdEmail size={"24.5px"}/>
            </a>
            <a
              href="https://twitter.com/getalterai"
              ...
              className={styles.footerElements}
            >
              <FaSquareXTwitter  size={"21px"}/>
            </a>
           
            <a
              href="https://www.linkedin.com/showcase/alter-ai-headshots/about/?viewAsMember=true"
              className={styles.footerElements}
              target="_blank"
            >
