...
const Footer = () => {
  ...
  const isHomePage =
    ...
    const energyStorage = learnGroups.energyStorage;
    const renewableEnergy = learnGroups.renewableEnergy;
    const electricVehicles = learnGroups.electricVehicles;
    const electricity = learnGroups.electricity;
    const grid = learnGroups.grid;
    const batteries = learnGroups.batteries;
          ...
          <div className={styles.Footer_root__HZhgG}>
            <div className={styles.Footer_content__4wtov}>
              ...
              <div className={styles.footerElementDesktop}>
                ...
                Xbattery™ builds Battery Management Systems for EVs and energy storage devices, combining both electronics and software.
                  <br />
                </div>
            ...
            <div className="w-[95%] mx-auto">
              ...
              >
                ...
                <span>
                  ...
                  {" and "}
                  <Link href={"/cookies"} className="underline hover:underline">
                    Cookies
                  </Link>
                  {"."}
                </span>
